...
- 공식 양식에 별도 개요 체계가 없는 경량 생성은 `1. / 1.1 / 1.1.1 / •`를 사용하고, 수준 1·2·3·본문 목록 앞에 일반 반각 공백을 각각 0·3·5·7개 기록함. 탭·특수 공백이나 문단 왼쪽 들여쓰기를 함께 넣어 간격을 대체하거나 이중 적용하지 않음
...
4. 생성 본문의 수준 1·2·3·본문 목록 앞 공백 0·3·5·7개, 3단계 초과 제목 부재와 문단 왼쪽 들여쓰기 중복 여부
...
- 제목 수준과 본문 목록의 앞 공백 0·3·5·7개 및 문단 들여쓰기 중복 부재 확인 결과
...
- 공식 양식 지정이 없는 경량 생성에서 4단계 이상의 숫자 제목을 만들거나 탭·특수 공백·문단 왼쪽 들여쓰기로 0·3·5·7개 공백 규칙을 대체·중복 적용
